...
START TRANSACTION;
USE `stackdb`;
INSERT INTO `technology` (`id`, `name`, `badge_url`, `description`) VALUES (1, 'Java', 'https://github.com/tandpfun/skill-icons/blob/main/icons/Java-Dark.svg', 'a multi-platform, object-oriented, and network-centric language that can be used as a platform in itself');
...
INSERT INTO `node` (`id`, `name`, `user_id`, `open_to_public`, `created_on`, `updated_on`, `state_abbreviation`, `description`, `image_url`, `enabled`, `city`, `nodecol`) VALUES (5, 'JavaScript off script', 5, 0, '2001-01-01 01:01:01', '2001-01-01 01:01:01', 'CO', 'JavaScript is our passion', 'https://img.freepik.com/free-vector/new-app-development-desktop_23-2148684987.jpg?size=626&ext=jpg&ga=GA1.1.996327085.1706734954&semt=sph', 1, 'Centennial', NULL);
